...
<template>
  <footer class="footer container">
    ...
    <div class="footer__pages">
      ...
      <a href="#" class="footer__page">Home</a>
      <a href="#" class="footer__page">Project</a>
      <a href="blog.html" class="footer__page">Blog</a>
    </div>
    <div class="footer__contacts">
      <h3 class="footer__contact_main">Contact</h3>
      <div class="footer__infoblock">
        <p class="footer__address footer__text footer__text_small">{{ address }}</p>
        <p class="footer__email footer__text footer__text_small">{{ email }}</p>
        <p class="footer__phone footer__text footer__text_small">{{ phone }}</p>
      </div>
    </div>
  </footer>
</template>
